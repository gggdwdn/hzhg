		...
		<div class="col-md-12" >
			...
			<input type="hidden" name="id" value="${entity.id}">
			   <div class="form-group">
			     ...
			     <div class="form-group">
				    <label class="col-md-2 control-label" style="padding-right:12px;">附件</label>
					<div class="col-md-10" id="editAttachmentDiv"></div>
			     </div>
			</form>
				...
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone'], function(A){
					...
					$('#editForm').validate({
						...
						submitHandler: function (form) {
							//添加按钮
							var url = format_url("/companyDynamic/saveEditPage");
