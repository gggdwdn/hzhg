					...
					var messageCenterDatatables = new A.datatables({
						...
						options: {
							...
							columns: [
							          ...
							          {data: "sendTime",width: "20%",orderable: true,sClass:'center'}, 
							          {data: "sendPerson",width: "20%",orderable: true}, 
							          {data: "messageTypeName",name:"type",width: "20%",orderable: true},
							          {data: "messageStatusName",name:"status",width: "auto",orderable: true}
							         ],
							toolbars: [{
								label:"删除",
