...
<html lang="zh">
	...
	<body>
			<form class="form-horizontal" role="form"  style="margin-right:100px;" id="sendForm">
		       ...
		       <div id="receivePersonDiv" class="form-group">
					<label class="col-md-2 control-label no-padding-right">
...
<!--                 	</div> -->
					 <div class="col-md-4">
						<select class="col-md-12 chosen-select" id=receivePerson name="receivePerson"></select>
                    </div>
               </div>
    		...
    		<div style="margin-right:100px;margin-bottom:50px;">
    			<button id="sendBtn" class="btn btn-xs btn-success pull-right">
...
// 					}).render();
					...
					//人员
					var comboUesrVO = ${comboUesrVO};
					var userCombobox = new A.combobox({
						render: "#receivePerson",
						//返回数据待后台返回TODO
						datasource:comboUesrVO,
						//multiple为true时select可以多选
						multiple:true,
						//allowBlank为false表示不允许为空
						allowBlank: true,
					...
					$('#sendForm').validate({
						...
						submitHandler: function (form) {
							...
							//if((typeof obj.receivePerson) != "string"){
							    obj.receivePerson = userCombobox.getValue();
							// }
							$.ajax({
								url : url,
								contentType : 'application/json',
