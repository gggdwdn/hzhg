...
<html lang="zh"> 
    <head>
		...
		<link rel="stylesheet" href="${ctx}/static/css/themes/${theme}/firstPage.css" />
		...
		<!-- 滚动样式 -->
		<link rel="stylesheet" href="${ctx}/static/css/themes/${theme}/liMarquee.css" />
		<!-- gritter -->
		<link rel="stylesheet" href="${ctx}/static/css/themes/${theme}/jquery.gritter.min.css" />
		<!-- 计时器组件 -->
		<link rel="stylesheet" href="${ctx}/static/css/themes/${theme}/flipclock.css" />
		...
		<link href="${ctx }/static/css/themes/default/css/exam.css" rel="stylesheet" type="text/css">
...
/* 		} */
	...
	<body class="no-skin"  scroll="no">
		<%@ include file="/WEB-INF/views/common/headerNew.jsp" %>
		<%@ include file="/WEB-INF/views/common/sidebarNew.jsp" %> 
...
// 				});
				$("#sidebar").yi_scroll({childPanel:'#sidebar-menu'});		
