...
<html lang="zh">
	...
	<body class="login-layout">
		<div class="headDiv">
			...
			<div class="login-text">岳能生产管理平台</div>
		</div>
							...
							<fieldset>
								...
								<label class="block clearfix form-group" style='margin-bottom:0'>
									<span class="block input-icon input-icon-right">
										<input class="form-control boxTwoInput" placeholder="用户名" type="text" name="username" value="admin"  id="userNameTwo">
									</span>
								</label>
								<label class="block clearfix form-group" style='margin-bottom:0'>
									<span class="block input-icon input-icon-right">
										<input class="form-control boxTwoInput" placeholder="密码" type="password" name="password" value="123456"  id="passWordTwo">
									</span>
								</label>
