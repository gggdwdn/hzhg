...
//            			iconNode = $('<i class="menu-icon '+ menuList[menu].icon +'"></i>')
//            		}
                	childrenA = $('<a href="#" class="dropdown-toggle"></a>')
                		.append(iconNode)
                		.append('<span class="menu-text"><i class="menu-icon menu-iocn-out ' + menuList[menu].icon+'" ></i>'+menuList[menu].name+'</span>')
                		.append('<b class="arrow glyphicon glyphicon-triangle-bottom"></b>');	
            	}else{
            		var iconNode = $('<i></i>');
            		if(parent.attr("id") != "sidebar-menu"){
            			iconNode = $('<i class="menu-icon '+ menuList[menu].icon +'"></i>')
            	...
            	childrenA.attr("data-menuid", menuList[menu].id);
