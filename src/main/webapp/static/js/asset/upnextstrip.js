define(function(require, exports, module){
	...
	Aptech.upnextstrip.prototype = {
			render:  function(){
				...
				var upperBtn=$('<button id="upperBtn" class="btn btn-xs btn-success pull-right"  style="margin-right:15px;margin-bottom:20px;">'+
				'<i class="glyphicon glyphicon-chevron-up"></i>上一条</button>');
				var nextBtn=$('<button id="nextBtn" class="btn btn-xs btn-success pull-right"  style="margin-right:15px;margin-bottom:20px;">'+
