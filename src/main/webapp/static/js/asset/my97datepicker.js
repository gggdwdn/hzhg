...
//			var inputValueNode = $("<input id='"+_self._config.name + "' name='"+ _self._config.name +"' type='hidden'>")
		    var iconNode =$('<span class="input-group-addon" style="width:1%;min-width:30px;max-width:30px;position: relative;z-index: 2;"><span class="fa fa-calendar-check-o"></span></span>');
