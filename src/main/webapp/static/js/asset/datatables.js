			...
			$.each(_self._options.columns, function(index, column){
				if(column.editType){
					column.createdCell = function(td, cellData, rowData, row, col){
						...
						if(column.editType=='input'){
							if(column.editHeight){
								if(column.editReadOnly){
									var inputNode = $('<input id="'+ column.data +'Data'+ rowData.id +'" name="'+ column.data +'" type="text" class="col-md-12" readonly="readonly" value="' + cellData +'" style="height:'+ column.editHeight +';width:'+column.editWidth+'" title='+cellData+'>');
								}else{
									if(column.onblur){
										var inputNode = $('<input id="'+ column.data +'Data'+ rowData.id +'" name="'+ column.data +'" type="text" class="col-md-12" value="' + cellData +'" style="height:'+ column.editHeight +';width:'+column.editWidth+'" onblur=inputBlur(this) title='+cellData+'>');
									}else{
										var inputNode = $('<input id="'+ column.data +'Data'+ rowData.id +'" name="'+ column.data +'" type="text" class="col-md-12" value="' + cellData +'" style="height:'+ column.editHeight +';width:'+column.editWidth+'" title='+cellData+'>');
									}
								}
							}else{
								if(column.editReadOnly){
									var inputNode = $('<input id="'+ column.data +'Data" name="'+ column.data +'" type="text" class="col-md-12" readonly="readonly" value="' + cellData +'" style="width:'+column.editWidth+'" title='+cellData+'>');
								}else{
									if(column.onblur){
										var inputNode = $('<input id="'+ column.data +'Data" name="'+ column.data +'" type="text" class="col-md-12" value="' + cellData +'" style="width:'+column.editWidth+'" onblur=inputBlur(this) title='+cellData+'>');
									}else{
										var inputNode = $('<input id="'+ column.data +'Data" name="'+ column.data +'" type="text" class="col-md-12" value="' + cellData +'" style="width:'+column.editWidth+'" title='+cellData+'>');
									}
								}
							}
							$(td).append(inputNode);
						...
						}if(column.editType == 'hyperlink'){
							var render = column.data + row;
							var containerName = column.data;
							if(column.data == null || column.data==""){
								containerName = column.name;
							}
							...
							var container = $('<a id="' + render +'" >'+cellData +'</a>');
							if(column.cfg.href){
								container.attr("href",column.cfg.href);
							}
							if(column.cfg.target){
								container.attr("target",column.cfg.target);
							}
							$(td).append(container);
